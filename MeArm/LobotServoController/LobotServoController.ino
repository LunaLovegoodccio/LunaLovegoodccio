...
#define  ID1   ((uint8_t)(1))
#define  ID2   ((uint8_t)(2))
...
void setup() {
  ...
  //myse.stopActionGroup(); //停止动作组运行
  //delay(2000);
  //myse.moveServo(1,1500,1000); //0号舵机1000ms移动至1500位置
  //delay(2000);
...
void loop() {
  myse.moveServo(ID1,1500,1000); //1号舵机1000ms移动至1500位置
  delay(2000);
  myse.moveServo(ID2,800,1000); //2号舵机1000ms移动至800位置
  delay(2000);
}
